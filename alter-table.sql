...
CREATE TABLE `ore-rd`.`ore_consuntivate_commesse` ( `COD_COMMESSA` VARCHAR(255) NOT NULL , `MATRICOLA_DIPENDENTE` VARCHAR(255) NOT NULL , `DATA` DATE NOT NULL , `RIF_DOC` VARCHAR(255) NOT NULL , `RIF_RIGA_DOC` INT NOT NULL , `NUM_ORE_LAVORATE` INT NOT NULL , `TMS_CARICAMENTO` TIMESTAMP NOT NULL , PRIMARY KEY (`COD_COMMESSA`, `MATRICOLA_DIPENDENTE`, `DATA`, `RIF_DOC`, `RIF_RIGA_DOC`)) ENGINE = InnoDB;

CREATE TABLE `ore-rd`.`ore_consuntivate_progetti` ( `ID_PROGETTO` INT NOT NULL , `MATRICOLA_DIPENDENTE` VARCHAR(255) NOT NULL , `DATA` DATE NOT NULL , `NUM_ORE_LAVORATE` INT NOT NULL , `COSTO_ORARIO` DECIMAL(16,2) NULL, COSTO DECIMAL(19,2) NULL, PRIMARY KEY (`ID_PROGETTO`, `MATRICOLA_DIPENDENTE`, `DATA`)) ENGINE = InnoDB;
