...
CREATE TABLE `assegnazioni_dettaglio` (
  ...
  `NUM_ORE_PRELEVATE` FLOAT NOT NULL DEFAULT 0.0,
  PRIMARY KEY (`ID_ESECUZIONE`, `COD_COMMESSA`,`MATRICOLA_DIPENDENTE`,`DATA`,`RIF_SERIE_DOC`,`RIF_NUMERO_DOC`,`RIF_ATV`,`RIF_SOTTO_COMMESSA`)
) ENGINE=InnoDB;
...
ALTER TABLE `progetti` ADD `OBIETTIVO_BUDGET_ORE` FLOAT NULL AFTER `MONTE_ORE_TOT`;
