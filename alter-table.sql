...
CREATE TABLE `ore-rd`.`ore_consuntivate_progetti` ( `ID_PROGETTO` INT NOT NULL , `MATRICOLA_DIPENDENTE` VARCHAR(255) NOT NULL , `DATA` DATE NOT NULL , `NUM_ORE_LAVORATE` FLOAT NOT NULL , `COSTO_ORARIO` DECIMAL(16,2) NULL, COSTO DECIMAL(19,2) NULL, `ID_ESECUZIONE` INT NULL , PRIMARY KEY (`ID_PROGETTO`, `MATRICOLA_DIPENDENTE`, `DATA`)) ENGINE = InnoDB;
