...
ALTER TABLE commesse ADD `TOT_ORE_PREVISTE` DECIMAL NOT NULL DEFAULT '0';
ALTER TABLE commesse ADD `TOT_ORE_RD_PREVISTE` DECIMAL NOT NULL DEFAULT '0';
ALTER TABLE commesse ADD `TIPOLOGIA` VARCHAR(255) NULL;
